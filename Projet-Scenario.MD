...
| **사용할 소프트웨어 패키지/명칭과 용도** | - **Qiskit**: 양자 연산 회로 설계 및 시뮬레이션, <br>- **PyTorch / TensorFlow**: Autoencoder/MLP 등 딥러닝 모델 구축 및 학습 프레임워크<br>- **Hugging Face PEFT Library**: LoRA 등, 효율적 전이 학습 라이브러리	<br>- **NumPy / Pandas**: 데이터 전처리 및 확률분포 계산<br>- **Matplotlib / Seaborn**: 데이터 시각화 라이브러리 <br>- **Jupyter Notebook / JupyterLab**: 대화형 개발 환경 - 코드 실행, 시각화, 문서화 <br>- **scikit-learn**: 머신러닝 라이브러리 - 데이터 전처리 |
